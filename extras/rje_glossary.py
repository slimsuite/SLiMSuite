...
def cmdHelp(info=None,out=None,cmd_list=[]):   ### Prints *.__doc__ and asks for more sys.argv commands
    ...
    try:### ~ [1] ~ Setup ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
        ...
        if help > 0:
            ...
            if rje.yesNo('Show HTML commandline options?'): out.verbose(-1,4,text=rje_html.__doc__)
        ...
        try:### ~ [1] Setup ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
            ...
            for termset in termsets:
                ...
                for term in termset:
                    ...
                    for word in string.split(term.lower()): akey.append(word); glossary = glossary[word]
                    #sethtml.append('<a name="%s"><li></a><p><scaps><b>%s.</b></scaps>' % (string.join(akey,'_'),term))
                    sethtml.append('<a name="%s"><p></a><scaps><b>%s.</b></scaps>' % (string.join(akey,'_'),term))
                ...
                #sethtml.append('</ul>')
                htmlsets.append(string.join(sethtml,'\n'))
            ## ~ [2d] HTML Options ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ##
