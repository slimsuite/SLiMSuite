...
#############################################################################################################################
    def calcScore(self,seqlist=[],query=None,methods=[],nonself=[]):     ### Calculates Specificity Scores determined by methods 
        ...
        try:
            ...
            if rje.join(methods).find('Info') >= 0:
                ## <i> ## Setup
            ...
            if rje.join(methods).find('PCon') >= 0:
                ## <i> ## Setup
                ...
                for r in range(0,seqlen):
                    if rje.join(methods).find('PCon_Abs') >= 0:
                        pcon = propx    # Abs PCon
                        qpcon= propx
                        ...
                        if rje.join(methods).find('QPCon_Abs') >= 0:
                            self.score['QPCon_Abs'].append(qpcon)
                    if rje.join(methods).find('PCon_Mean') >= 0:
                        mpcon = 0.0     # Mean PCon
                        mpx = 0
                        ...
                        if rje.join(methods).find('QPCon_Mean') >= 0:
