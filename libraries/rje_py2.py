...
"""
Module:       rje_py2
Description:  Python 2.7 versions of core methods
Version:      0.0.0
Last Edit:    21/08/20
...
Function:
    ...
    Python 3.x syntax. See the corresponding rje_py3.py module for the Python 3 versions. The main rje.py will import
