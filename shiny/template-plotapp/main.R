...
info = list(
  ...
  description = "Generic plotting app template."
)
...
################# ::: TO DO LIST ::: ######################
# [ ] : Generate list of things to do to make functional app.
...
############### ::: LOAD R LIBRARIES ::: ##################
# R code containing general functions:
source("functions.R")
# R code containing functions for filtering data:
source("filter.R")
# R code containing functions for plotting data:
source("plot.R")

############### ::: SET DEFAULTS ::: ##################
## Defaults in the settings list 
settings = list(
  # General app settings
  testing=FALSE,   # Whether to run in testing mode
  debug = FALSE,   # Whether to run in debugging mode
...
if(getwd() == "/Users/redwards/Dropbox/code/slimsuite/shiny/template-plotapp"){
...
setupData = function(){
  emptydb = list()        # This list will be set up as `adata` and passed to functions as `appdata`.
  emptydb$data = list()   # List for 1+ data.frame objects, loaded from files.
  emptydb$settings = settings    # This is populated by the app settings, updated by UI settings.
  emptydb$col = acol     # Set up a list with colours to be used in the app. (Function in functions.R)
  ...
  # The intro element contains the text for the intro verbatimTextOutput UI element 
  emptydb$intro = "Load data. (See Instructions Tab)"   
  # The activitylog element contains the text displayed in the Log panel 
