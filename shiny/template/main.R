################# ::: APP INFO ::: ######################
info = list(
  apptitle = "SLiMSuite Template App",
  version = "0.1.0",
  lastedit = "25/09/2017",
  author = "Richard J. Edwards",
  contact = "richard.edwards@unsw.edu.au",
  description = "Template SLiMSuite Shiny app using the [SLiMSuite random Zen wisdom](http://rest.slimsuite.unsw.edu.au/zen) server."
)
...
setupData = function(){
  ...
  emptydb$intro = "Enter valid JobID and click Retrieve."
  # Return data list
  return(emptydb)
}
