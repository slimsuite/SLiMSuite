...
def makeInfo():     ### Makes Info object
    ...
    (program, version, last_edit, copyright) = ('UNIFAKE', '1.3.1', 'May 2022', '2008')
    description = 'Fake UniProt DAT File Generator'
...
#########################################################################################################################
    def uniFake(self,seqs=[],store=False):  ### Main UniFake method. Runs on sequences in self.obj['SeqList'] if no seqs.
        ...
        try:### ~ [1] Setup ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
            unifake = rje.split(rje.join(self.list['UniFake']).lower())
            ...
            for seq in seqs:
                ...
                try:
                    ...
                    for id in [seq.shortName(),seq.info['AccNum']]:
                        if id in self.dict['Aliases']: udata['AC'].append('%s;' % rje.join(self.dict['Aliases'][id],'; '))
                    ## ~ [2c] ~ Features ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ##
    ...
    def loadFeatures(self,ftfile):  ### Loads features from given file
        ...
        try:### ~ [1] ~ Setup ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
            ...
            for mainkey in rje.sortKeys(ftdata):
                ...
                mx += 100.0                                                                           
                (id,ft,start,end) = rje.split(mainkey,delimit)
            ...
            for entry in realuni.list['Entry']:
                ...
                for key in self.list['UniReal']:    #['AC','GN','RC','RX','CC','DR','PE','KW']:
                    if key in entry.dict['Data']:
                        if key in udata: udata[key] = entry.dict['Data'][key] + udata[key]
